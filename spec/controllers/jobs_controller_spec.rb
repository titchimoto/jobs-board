...
RSpec.describe JobsController, type: :controller do
  ...
  let(:other_user) { User.create!(username: "Mickey", email: "mickeymouse@testing.com", password: "password", role: 0) }
...
# testing
  ...
  context "signed in employer user performing CRUD on things they DON'T own" do
    before do
      other_user.confirm
      other_user.employer!
      sign_in other_user
 ...
 context "signed in employer user performing CRUD on things they own" do
   before do
     user.confirm
     user.employer!
     sign_in user
